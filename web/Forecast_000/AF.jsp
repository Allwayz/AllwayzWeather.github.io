...
<html>
    ...
    <body>
        ...
        <table style="font-size:22px; border-collapse:separate; border-spacing:10px; " border="2" bgcolor="#efefef">
            <thead>
                <tr>
                    <th colspan="8"><local_header>AF</local_header></th>
                </tr>
			...
			<option value="red"style="background-color:red">Cairo</option>
			<option value="green" style="background-color:green">Wakanda</option>
			<option value="blue" style="background-color:blue">Cape Town</option>
		</select></td>
                <td colspan="8" >
            <dvi id="text">
			IMG<br/>
