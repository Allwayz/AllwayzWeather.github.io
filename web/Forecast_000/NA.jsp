...
<html>
    ...
    <body>
        ...
        <table style="font-size:22px; border-collapse:separate; border-spacing:10px; " border="2" bgcolor="#efefef">
            <thead>
                <tr>
                    <th colspan="8"><local_header>NA</local_header></th>
                </tr>
			...
			<option value="red"style="background-color:red">New york</option>
			<option value="green" style="background-color:green">Washington</option>
			<option value="blue" style="background-color:blue">Ottawa</option>
		</select></td>
                <td colspan="8" >
            <dvi id="text">
			IMG<br/>
